...
<html>
	...
	<head>
		<?php
		    ...
		    $sql1="select yonghuemail,zhuti,neirong,fangxiangming,chuangjianshijian,jiezhishijian,fujian,renwuzhuangtai,fujianming from renwu where id='$id'";
				...
				<div class="col-xs-3 col-xs-offset-6">
					<?php
			  			if(isset($_SESSION["user"]))
			  			{
					  		...
					  		echo '&nbsp;&nbsp;&nbsp;<a href="houtai/exit.php" style="color: rgb(255,255,255)"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span> 退出</a>';
					...
					<div>
						<?php 
							if($renwuzhuangtai != 3)
								...
								echo "<h3>{$zhuti}<p style='color:red'>(已过期！)</p></h3>  ";
							echo "<p style='font-size:18px'>{$neirong}</p> <br />";
							...
							foreach($array as $key=>$values)
							    	{
							    		$pinglunsql="select email,neirong,tijiaoshijian from pinglun where suoshuzuoyeid='$values->id'";
